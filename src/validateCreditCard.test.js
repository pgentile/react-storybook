...
describe("Valid credit cards", () => {
  const testCases = [
    {
      issuer: "VISA",
      creditCards: ["4111 1111 1111 1111", "4742 0163 5779 3141", "4778 1357 4772 9230", "4250 4977 1554 2988"]
    },
    {
      issuer: "Mastercard",
      creditCards: ["5212 5349 2870 6168", "5363 5408 1075 1615", "5342 3217 6638 4297", "5579 0498 7984 3339"]
    },
    {
      issuer: "American Express",
      creditCards: ["3791 9410 9437 636", "3723 2984 5398 059", "3782 8224 6310 005"]
    },
    {
      issuer: "Maestro",
      creditCards: [
  ...
  testCases.forEach(testCase => {
    describe(`Valid ${testCase.issuer} cards`, () => {
      testCase.creditCards.forEach(creditCard => {
        test(`${creditCard} is a valid ${testCase.issuer} credit card number`, () => {
