...
export default validateAll(
  ...
  validateAny(
    // AMEX
    validateAll(
      fixedSizeValidator(15),
      validateAny(
        iinPrefixValidator('34'),
        iinPrefixValidator('37'),
      ),
    ),
    // Visa
    validateAll(
      ...
      validateAny(
        fixedSizeValidator(13),
        fixedSizeValidator(16),
        fixedSizeValidator(19),
      ),
    ),
    // Mastercard
    validateAll(
      fixedSizeValidator(16),
      validateAny(
        iinPrefixRangeValidator('51', '55'),
        iinPrefixRangeValidator('2221', '2720'),
      ),
    ),
    // Maestro
    validateAll(
      ...
      validateAny(
        iinPrefixValidator('50'),
        iinPrefixValidator('6'),
        iinPrefixRangeValidator('56', '58'),
      ),
    ),
  ),
);
